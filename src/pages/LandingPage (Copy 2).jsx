          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <Card className="border-gray-100 hover:border-cyan-500 transition-all duration-300 hover:shadow-lg group">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Automatically pulls data from communication channels (e.g., Slack, Microsoft Teams), task management tools (e.g., GitHub, Jira), risk registers (e.g., Excel, Google Sheets), meeting minutes repositories (e.g., Confluence), and time-tracking systems (e.g., Clockify).
                </p>
            ...
            <Card className="border-gray-100 hover:border-cyan-500 transition-all duration-300 hover:shadow-lg group">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Interprets unstructured data and generates natural-language executive summaries with actionable next steps, using your preferred AI model (e.g., GPT, Gemini, Claude) or a locally hosted LLM for full data privacy.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-gray-100 hover:border-cyan-500 transition-all duration-300 hover:shadow-lg group">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Key metrics are stored in the database of your choice (e.g., Postgres, MySQL, MariaDB, SQLite, CockroachDB) and visualized in real-time Superset dashboards.
                </p>
              </CardContent>
            </Card>
          </div>
